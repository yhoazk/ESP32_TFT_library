...
*/
//-------------------------------------------------------------------
// CHANGE NOTICE: because with the use of the upstream spi_master driver it is no longer nessecairy,
//                the uint8_t sel argument was removed, you can just remove it from your code
